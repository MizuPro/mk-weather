...
const DetailCard = ({ icon, label, value, unit, delay }) => {
  const Icon = icon;
  return (
    <div
      className="glass-card flex flex-col items-center justify-center p-4 hover:-translate-y-1 transition-transform animate-fade-up"
