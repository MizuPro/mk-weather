  ...
  return (
    <div className="relative w-full max-w-md mx-auto z-50">
      <motion.div
        ...
        className="glass-card flex items-center p-2 mt-6"
      >
      ...
      <AnimatePresence>
        {showDropdown && results.length > 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-full left-0 right-0 mt-2 glass-card overflow-hidden max-h-60 overflow-y-auto no-scrollbar"
          >
